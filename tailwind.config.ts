    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          "working-foreground": "hsl(var(--status-working-foreground))",
          ...
          "pending-exit": "hsl(var(--status-pending-exit))",
          "pending-exit-foreground": "hsl(var(--status-pending-exit-foreground))",
        },
        kpi: {
          total: "hsl(var(--kpi-total))",
          working: "hsl(var(--kpi-working))",
          finished: "hsl(var(--kpi-finished))",
